...
public class ex9_KaminoFactory {
    public static void main(String[] args) {
        ...
        int longDNK = Integer.parseInt(scanner.nextLine());
        String cloneDNK = scanner.nextLine();
        ...
        while (!"Clone them!".equals(cloneDNK)) {
            ...
            int sum = 0;
            int[] oneZero = Arrays.stream(cloneDNK.split("!+")).
            ...
            if (longestSequenceTwo > bestLongest
                    || (longestSequenceTwo == bestLongest &&
                    sequenceIndexTemp < bestSequenceIndex)
                    || (longestSequenceTwo == bestLongest &&
                    sequenceIndexTemp == bestSequenceIndex && sum > bestSum)) {
